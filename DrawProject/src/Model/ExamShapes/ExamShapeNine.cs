...
{
    public class ExamShapeNine : Shape
    {
        public ExamShapeNine(RectangleF elp) : base(elp)
        {
        }

        public ExamShapeNine(ExamShapeNine elipsa) : base(elipsa)
        {
        }
        ...
        public override void DrawSelf(Graphics grfx)
        {
            ...
            x2 = (float)(x0 + r * Math.Cos(45 * (Math.PI / 180)));
            y2 = (float)(y0 + r * Math.Sin(45 * (Math.PI / 180)));

            x3 = (float)(x0 + r * Math.Cos(-45 * (Math.PI / 180)));
            y3 = (float)(y0 + r * Math.Sin(-45 * (Math.PI / 180)));

            x4 = (float)(x0 + r * Math.Cos(120 * (Math.PI / 180)));
            y4 = (float)(y0 + r * Math.Sin(120 * (Math.PI / 180)));

            grfx.DrawLine(Pens.Black, x1, y1, x2, y2);
            grfx.DrawLine(Pens.Black, x3, y3, x4, y4);
            grfx.DrawLine(Pens.Black, x0, Rectangle.Y, x0, Rectangle.Y + Rectangle.Height);
